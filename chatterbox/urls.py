...
from apps.chatterprofile.views import chatterprofile, edit_profile, follow_chatter, unfollow_chatter, followers, follows
from apps.conversation.views import conversations, conversation

from apps.conversation.api import api_add_message
from apps.feed.api import api_add_chat, api_add_like
...
urlpatterns = [
    ...
    path('u/<str:username>/', chatterprofile, name='chatterprofile'),
    path('u/<str:username>/followers/', followers, name='followers'),
    path('u/<str:username>/follows/', follows, name='follows'),
    path('u/<str:username>/follow/', follow_chatter, name='follow_chatter'),
    path('u/<str:username>/unfollow/', unfollow_chatter, name='unfollow_chatter'),
    ...
    path('api/add_chat/', api_add_chat, name='api_add_chat'),
